        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              CareBridge helps you track growth, schedule activities, and manage the development of children with autism. A simple, supportive tool for parents and caregivers.
            </p>
